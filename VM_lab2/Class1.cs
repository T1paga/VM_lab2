...
namespace Class1
{
    internal class RomanNumber : ICloneable, IComparable
    {
        ...
        {
            if (n <= 0) throw new RomanNumberException($"Number {n} or less equals 0");
            else this._number = n;
        }
        ...
        {
            int num = n1._number - n2._number;
            if (num <= 0) throw new RomanNumberException("The result of the subtraction is less than or equal to 0!");
            else
            {
                RomanNumber result = new((ushort)num);
                return result;
        ...
        {
            int num = n1._number * n2._number;
            if (num <= 0) throw new RomanNumberException("Failed to multiply 2 numbers!");
            else
            {
                RomanNumber result = new((ushort)num);
                return result;
        ...
        public static RomanNumber Div(RomanNumber? n1, RomanNumber? n2)
        {
            ...
            if (n2._number == 0) throw new RomanNumberException("Division error!");
            else
            {
                int num = n1._number / n2._number;
        ...
        public override string ToString()
        {
            ...
            if (result.ToString() == "")
                throw new RomanNumberException("Number conversion to Roman numerals is not possible");
            else
